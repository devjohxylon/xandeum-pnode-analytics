...
export function FeaturedCharts() {
  ...
  const avgUptime = nodes
    ...
    : 0;
  const uptimeData = generateHistoricalData(hours, avgUptime, 0.05).map((item) => ({
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 animate-fade-in">
      {/* Network Uptime Chart */}
      <Card className="border-0 bg-gradient-to-br from-blue-950/50 to-cyan-950/50 backdrop-blur-sm shadow-xl">
      ...
      {/* Storage Utilization Chart */}
      <Card className="border-0 bg-gradient-to-br from-purple-950/50 to-pink-950/50 backdrop-blur-sm shadow-xl">
        <CardHeader className="border-b border-white/10">
            ...
            <AreaChart data={storageData}>
              <defs>
                ...
                <linearGradient id="totalGradient" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="hsl(280, 50%, 50%)" stopOpacity={0.3} />
                  <stop offset="95%" stopColor="hsl(280, 50%, 50%)" stopOpacity={0.05} />
                </linearGradient>
              </defs>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.1)" />
              <XAxis
